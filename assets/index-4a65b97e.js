...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Dn,depthTest:!1,depthWrite:!1})}function ll(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Co(),fragmentShader:`
		...
		`,blending:Dn,depthTest:!1,depthWrite:!1})}function cl(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Co(),fragmentShader:`
...
`].filter($i).join(`
`)),o=lo(o),o=vl(o,t),o=yl(o,t),a=lo(a),a=vl(a,t),a=yl(a,t),o=xl(o),a=xl(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(S=`#version 300 es
